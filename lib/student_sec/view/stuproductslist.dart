    ...
    return Scaffold(
        ...
        body: SafeArea(
          child: StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection("products").where("storeId",isEqualTo: docId).snapshots(),
                      ...
                      child: ListTile(
                        ...
                        trailing: ElevatedButton(
                            onPressed: () {
                              ...
                              Get.to(() =>ConfirmOrderView(storeId: docId,productId: doc.id,productData: productData));
                            },
                            child: Text("Buy")),
                      )),
                );
